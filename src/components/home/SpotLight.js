        ...
        <div className="spotlight-post-item-wrap">
          <div className="section-title-wrap-three mb-20">
            ...
            <div className="view-all-btn mb-4">
              <Link
                href={`/${spotlight[0].category_type}/${spotlight[0].category_data_query}`}
                className="link-btn"
              >
                View All
          ...
          {spotlight.map((item, index) => (
            <div className="row" key={index}>
              ...
              <div
                className="weekly-post-content mb-4"
              ...
              >
                ...
                <p>
                  {item.sub_title.length > 250
                    ? `${item.sub_title.slice(0, 250)}...`
                    : item.sub_title}
                </p>
