  ...
  const handleTwitterShare = (slug, title, img, subTitle) => {
    if (typeof window !== "undefined") {
      const shareUrl = `https://twitter.com/intent/tweet?url=${encodeURIComponent(
        window.location.origin + "/" + slug
      )}&text=${encodeURIComponent(title)}&image=${encodeURIComponent(
        img
          ...
          {posts.map((post, index) => (
            <div className="col-lg-12 col-md-12" key={index}>
              <div className="banner-post-five banner-post-seven">
                ...
                <div
                  className="banner-post-content-five"
                  style={{ borderBottom: "1px solid #e4e4e4" }}
                >
                  <Link
                    href={`/${post.category_type}/${post.category_data_query}`}
                    className="post-tag my-3"
                  >
                    {post.category_name}
                  </Link>
                      ...
                      <li className="col-6 ">
                        ...
                        <div className="col-20">
                          <button
                            ...
                            className={
                              clickedBlogArticleIconId.includes(post.id)
                                ? "blog-article-icon-heart-clicked"
                                : ""
                            }
