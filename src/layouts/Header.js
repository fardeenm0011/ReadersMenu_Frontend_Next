...
const Header = () => {
  ...
  const handleCategoryClick = () => {
    setActiveCategory((prevActiveCategory) => ({
      ...
      show:
        prevActiveCategory.category !== category.name
          ? true
          : !prevActiveCategory.show,
    }));
  };
  ...
  useEffect(() => {
    const handleOutsideClick = (event) => {
      if (
        ...
        !event.target.closest("#mobileMenuToggleBtn")
      ) {
        setShowToggleMenu(false);
        setShowToggleSubMenu(false);
        setActiveCategory({ category: null, show: false });
    ...
    <header className="header-style-six">
      <div className="header-top-wrap-four">
        <div className="row align-items-center">
                ...
                <div className="myswiper-wrapper">
                  <div className="swiper-slide">
                    <a href="/">
                      <img
                        src={
                          setting.site_logo !== undefined
                            ? IMAGE_BASE_URL + "setting/" + setting.site_logo
                            : DEFAULT_LOGO
                        }
                        alt="logo"
          ...
          <div
            className="col-lg-6 col-md-6 col-7"
            ...
            <div className="header-top-social header-top-social-two">
              <ul className="list-wrap">
                <li className="social-icons">
                  <span>
                    <Link
                      href={setting.social_fb ? setting.social_fb : SOCIAL_FB}
                      target="blank"
                    >
                                  ...
                                  {category.child.map((subCategory) => (
                                    ...
                                    >
                                      <Link
                                        ...
                                        onClick={() =>
                                          handleLinkClick(subCategory.name)
                                        }
