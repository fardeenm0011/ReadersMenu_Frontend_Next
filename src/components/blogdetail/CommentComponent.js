            ...
            <li>
              <div className="comments-box">
                <div className="comments-avatar">
                  <img
                    src={IMAGE_BASE_URL + "profile/" + comment.user.avatar}
                    alt="img"
                  />
                </div>
                <div className="comments-text">
                  <div className="avatar-name">
                    ...
                    <span className="date">
                      {format(new Date(comment.updated_at), "dd MMMM, yyyy")}
                    </span>
                  </div>
                  <p>{comment.content}</p>
                  <p
                    className={
                      clickedReplyId === comment.id
                        ? "reply-btn-active"
                        : "reply-btn"
                    }
                    onClick={() =>
              ...
              {comment.child && comment.child.length > 0 && (
                <ul className="children">{renderComments(comment.child)}</ul>
              )}
            </li>
          </ul>
        ))}
