...
const Menu = () => {
  ...
  if (mainCategories.length > 7)
    setMoreCategories([...moreCategories, ...mainCategories.slice(7)]);
          ...
          <ul className="dropdown-content mb-10">
            ...
            {mainCategories.map((category) => (
              ...
              >
                {!category.child ? (
                  ...
                  <div
                    className="category-link-with-dropdown"
                  ...
                  >
                    ...
                    {activeCategory === category.name && (
                      <ul
                        className="left-menu-dropleft sub-category dropdown-content show-dropleft"
                        onMouseLeave={handleCategoryMouseLeave}
                      >
                        {category.child.map((subCategory) => (
                          ...
                          >
                            <Link
                              ...
                              onMouseEnter={() =>
                                setActiveLink(subCategory.name)
                              }
                            >
                              {subCategory.name}
                            </Link>
            ...
            {moreCategories.length > 0 && (
              ...
              >
                ...
                <ul
                  className={`left-menu-dropleft view-more dropdown-content ${
                    showDropleft ? "show-dropleft" : ""
                  }`}
                >
                              ...
                              {category.child.map((moreSubCategory) => (
                                <li
                                  className={
                                    (selectCategory
                                      ? selectCategory
                                      : activeLink) === moreSubCategory.name
                                      ? "active"
                                      : ""
                                  }
                                ...
                                >
                                  <Link
                                    ...
                                    onClick={() =>
                                      handleLinkClick(moreSubCategory.name)
                                    }
                                    onMouseEnter={() =>
                                      setActiveLink(moreSubCategory.name)
                                    }
                                  >
