    ...
    if (typeof window !== "undefined") {
      const shareUrl = `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(
        window.location.origin +
          "/" +
          (type === "news" ? "news_detail" : "article_detail") +
          "/" +
          slug
      )}`;
            ...
            <div className="col-lg-12">
              <div className="section-title-wrap-three mb-20">
                ...
                <div className="view-all-btn mb-4">
                  <Link
                    href={`/${
                      posts[0].category_type === "news" ? "news" : "article"
                    }/${posts[0].category.data_query}`}
                    className="link-btn"
            ...
            <div className="editor-post-wrap" key={index}>
              <div className="row editor-post-active">
                {posts
                  .slice(
                    index * 1,
                    index * 1 + 1 < posts.length ? index * 1 + 1 : posts.length
                  )
                  .map((post) => (
